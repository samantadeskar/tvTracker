...
import com.example.samanta.tvtrackermvp.presenters.PopularMoviesPresenter;
import com.example.samanta.tvtrackermvp.presenters.PopularMoviesPresenterImpl;
...
public class PopularMoviesFragment extends Fragment
        implements PopularMoviesView, MovieClickListener,
        AddToWatchlistClickListener {


    private PopularMoviesPresenter presenter = new PopularMoviesPresenterImpl();
    MoviesAdapter adapter;

    @BindView(R.id.recyclerPopularMovies)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_popular_movies,
                container,
                false);
    }
    ...
    public void onViewCreated(@NonNull View view,
        ...
        recyclerPopularMovies.setLayoutManager(linearLayoutManager);
        recyclerPopularMovies.setItemAnimator(new DefaultItemAnimator());
        recyclerPopularMovies.setAdapter(adapter);

        EndlessScrollListener scrollListener = new EndlessScrollListener(linearLayoutManager) {
            @Override
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                presenter.addPopularMovies(page);
            }
        };
        recyclerPopularMovies.addOnScrollListener(scrollListener);
