package com.example.samanta.tvtrackermvp.ui.watchlist;
...
import com.example.samanta.tvtrackermvp.presenters.WatchlistPresenter;
import com.example.samanta.tvtrackermvp.presenters.WatchlistPresenterImpl;
...
import com.example.samanta.tvtrackermvp.ui.watchlist.adapters.WatchlistPagerAdapter;
...
public class WatchlistActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, WatchlistView {
    ...
    WatchlistPresenter presenter = new WatchlistPresenterImpl();
    ...
    public void setUpFragments() {
        ...
        pagerAdapter = new WatchlistPagerAdapter(getSupportFragmentManager(),
                tabLayoutWatchlist.getTabCount());
        List<Fragment> pages = new ArrayList<>();
        pages.add(new WatchlistMoviesFragment());
        pages.add(new WatchlistTvShowsFragment());
