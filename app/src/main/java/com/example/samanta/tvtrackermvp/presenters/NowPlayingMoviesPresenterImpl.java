...
public class NowPlayingMoviesPresenterImpl implements NowPlayingMoviesPresenter {

    private NowPlayingMoviesView view;
    ...
    @Override
    public void setBaseView(NowPlayingMoviesView view) {
        this.view = view;
    }

    @Override
    public void getNowPlayingMovies(int page) {
        interactor.getNowPlayingMovies(page, getMoviesCallback());
    }

    @Override
    public void addNowPlayingMovies(int page) {
        interactor.getNowPlayingMovies(page, addNowPlayingMoviesCallback());
    ...
    private Callback<MovieResponse> addNowPlayingMoviesCallback() {
        return new Callback<MovieResponse>() {
            @Override
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                if (response.isSuccessful()) {
